...
|------|------|
| **高性能加速库** | 预置算子与加速实现 |
| **算子编程体系** | Ascend C、[[pto-isa|PTO tile 虚拟 ISA]] 等，面向 [[cube-core]]/[[vector-core]] 开发 |
| **编译器** | 算子编译、图编译 |
...
- 概念：[[davinci-core-gen3]]、[[pto-comm-isa]]
- 综合：[[flashattention-optimization]]、[[ascend-glossary]]
- 资料：[[source-ascend-950-npu-whitepaper]]、[[source-pto-isa]]
